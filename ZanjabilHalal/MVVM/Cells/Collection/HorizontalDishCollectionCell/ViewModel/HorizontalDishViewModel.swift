...
final class HorizontalDishViewModel: MVVMViewModelProtocol {
    
    public var model: HorizontalDishModel? {
        didSet { self.stateHorizontalMenuModel() }
    }
    
    //MARK: - View
    public var mainView: HorizontalDishCollectionCell?
    public var isUpdate: ClosureEmpty?
    // MARK: - DI
    @Injected
    private var mainViewsBuilder: MainViewsBuilder
    
    private func stateHorizontalMenuModel(){
        ...
        switch model {
            case .createViewProperties(let dish):
                ...
                let viewProperties = HorizontalDishCollectionCell.ViewProperties(dish                : dish,
    ...
    init(with mainView: HorizontalDishCollectionCell) {
